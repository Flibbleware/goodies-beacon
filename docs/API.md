...
| `PATCH` | `/api/candidates/:id` | session | required |
| `GET` | `/api/categories` | session | — |
| `POST` | `/api/categories` | session | required |
| `DELETE` | `/api/categories/:id` | session | required |
| `PUT` | `/api/categories/:id` | session | required |
